    ...
    <div className="container mx-auto p-8 max-w-2xl">
      ...
      <form action={addCompany} className="flex flex-col gap-6 border p-8 rounded-lg bg-white shadow-sm">
        <label className="flex flex-col gap-2">
          ...
          <input name="name" type="text" required className="border rounded px-3 py-2" placeholder="株式会社〇〇" />
        </label>

        <label className="flex flex-col gap-2">
          <span className="font-medium">URL</span>
          <input name="url" type="url" className="border rounded px-3 py-2" placeholder="https://example.com" />
        </label>
