...
export default async function Home() {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8 max-w-7xl space-y-6">
      ...
      {/* ヒーローエリア */}
      <section className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-md shadow-indigo-100 dark:shadow-none border border-indigo-50 dark:border-gray-700 relative overflow-hidden bg-dot-pattern">
        {/* 装飾背景 (薄く) */}
        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center justify-between">
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              <div className="bg-white dark:bg-gray-700 px-4 py-2 rounded-xl shadow-sm border border-gray-200 dark:border-gray-600 flex items-center gap-3">
          ...
          <div className="flex-shrink-0 w-48 h-48 relative flex items-center justify-center bg-white/50 dark:bg-gray-700/30 rounded-full backdrop-blur-sm shadow-inner border border-white/50 dark:border-gray-600">
             {totalCompanies > 0 ? (
                <svg viewBox="0 0 100 100" className="w-full h-full rotate-[-90deg]">
                  ...
                  <circle cx="50" cy="50" r="30" fill="currentColor" className="text-white dark:text-gray-800" />
                </svg>
             ) : (
                <div className="text-gray-400 text-center text-xs">データなし</div>
             )}
             <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-3xl font-bold text-gray-800 dark:text-white font-sans">{totalCompanies}</span>
                <span className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider">Total</span>
             </div>
          </div>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
           ...
           <section>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <Link href="/companies/new" className="group p-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-2xl shadow-md shadow-indigo-100/50 dark:shadow-none hover:shadow-lg border border-gray-100 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-500 transition-all hover:-translate-y-1 flex flex-col items-center justify-center gap-3 h-32 relative overflow-hidden">
                      ...
                      <div className="bg-indigo-100 dark:bg-indigo-900/30 p-3 rounded-2xl group-hover:bg-indigo-200 dark:group-hover:bg-indigo-900/50 transition-colors">
                        <Building2 className="w-6 h-6 text-indigo-600 dark:text-indigo-400" />
                      </div>
                      <span className="font-bold text-sm text-gray-600 dark:text-gray-300 group-hover:text-indigo-700 dark:group-hover:text-white transition-colors">企業追加</span>
                  </Link>
                  
                  <Link href="/companies" className="group p-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-2xl shadow-md shadow-blue-100/50 dark:shadow-none hover:shadow-lg border border-gray-100 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-500 transition-all hover:-translate-y-1 flex flex-col items-center justify-center gap-3 h-32 relative overflow-hidden">
                      ...
                      <div className="bg-blue-100 dark:bg-blue-900/30 p-3 rounded-2xl group-hover:bg-blue-200 dark:group-hover:bg-blue-900/50 transition-colors">
                         <FileText className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                      </div>
                      <span className="font-bold text-sm text-gray-600 dark:text-gray-300 group-hover:text-blue-700 dark:group-hover:text-white transition-colors">ES管理</span>
                  </Link>

                  <Link href="/companies" className="group p-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-2xl shadow-md shadow-amber-100/50 dark:shadow-none hover:shadow-lg border border-gray-100 dark:border-gray-700 hover:border-amber-300 dark:hover:border-amber-500 transition-all hover:-translate-y-1 flex flex-col items-center justify-center gap-3 h-32 relative overflow-hidden">
                      ...
                      <div className="bg-amber-100 dark:bg-amber-900/30 p-3 rounded-2xl group-hover:bg-amber-200 dark:group-hover:bg-amber-900/50 transition-colors">
                         <Calendar className="w-6 h-6 text-amber-600 dark:text-amber-400" />
                      </div>
                      <span className="font-bold text-sm text-gray-600 dark:text-gray-300 group-hover:text-amber-700 dark:group-hover:text-white transition-colors">カレンダー</span>
                  </Link>

                  <Link href="/companies" className="group p-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-2xl shadow-md shadow-rose-100/50 dark:shadow-none hover:shadow-lg border border-gray-100 dark:border-gray-700 hover:border-rose-300 dark:hover:border-rose-500 transition-all hover:-translate-y-1 flex flex-col items-center justify-center gap-3 h-32 relative overflow-hidden">
                      ...
                      <div className="bg-rose-100 dark:bg-rose-900/30 p-3 rounded-2xl group-hover:bg-rose-200 dark:group-hover:bg-rose-900/50 transition-colors">
                         <BarChart2 className="w-6 h-6 text-rose-600 dark:text-rose-400" />
                      </div>
                      <span className="font-bold text-sm text-gray-600 dark:text-gray-300 group-hover:text-rose-700 dark:group-hover:text-white transition-colors">分析</span>
                  </Link>
              </div>
           </section>
        </div>
        ...
        <div className="lg:col-span-1 space-y-8">
            {/* 未完了タスク */}
            <section className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-md shadow-indigo-50 dark:shadow-none relative overflow-hidden group hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                {pendingTasks && pendingTasks.length > 0 ? (
                    ...
                    {pendingTasks.map((task) => (
                        <Link href={`/companies/${task.company_id || '#'}`} key={task.id} className="block group/item">
                            <div className="flex items-start gap-3 p-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-indigo-400 dark:hover:border-indigo-500 transition shadow-sm hover:shadow-md">
            ...
            {/* 最近の活動 */}
            <section className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-md shadow-gray-100 dark:shadow-none hover:shadow-lg transition-all">
                ...
                <div className="relative pl-4 border-l-2 border-gray-100 dark:border-gray-700 space-y-8 py-2">
                    <div className="relative group">
                        <div className="absolute -left-[21px] top-0 w-3 h-3 rounded-full bg-indigo-500 ring-4 ring-white dark:ring-gray-800 group-hover:scale-125 transition-transform shadow-sm"></div>
                    ...
                    <div className="relative group">
                        <div className="absolute -left-[21px] top-0 w-3 h-3 rounded-full bg-gray-300 dark:bg-gray-600 ring-4 ring-white dark:ring-gray-800 group-hover:scale-125 transition-transform shadow-sm"></div>
