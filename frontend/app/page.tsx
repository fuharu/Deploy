        ...
        <div className="lg:col-span-2 space-y-6">
           ...
           <section>
              <h2 className="text-lg font-bold mb-3 dark:text-white flex items-center gap-2">
                 <Rocket className="w-5 h-5 text-gray-700 dark:text-gray-300" /> クイックアクセス
              </h2>
              <div className="grid grid-cols-2 gap-4">
                  <Link href="/companies/new" className="group p-4 bg-gray-900 dark:bg-gray-800 text-white rounded-xl shadow-sm hover:bg-gray-800 dark:hover:bg-gray-700 transition flex flex-col items-center justify-center gap-2 h-24">
                      <Building2 className="w-6 h-6 group-hover:scale-110 transition transform text-gray-300 group-hover:text-white" />
                      <span className="font-bold text-sm">企業を追加</span>
                  </Link>
                  
                  <Link href="/companies" className="group p-4 bg-white dark:bg-gray-800 border dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl shadow-sm hover:border-gray-400 dark:hover:border-gray-600 transition flex flex-col items-center justify-center gap-2 h-24">
                      <FileText className="w-6 h-6 text-gray-500 group-hover:text-gray-900 dark:group-hover:text-white transition" />
            ...
            <section className="bg-white dark:bg-gray-800 p-5 rounded-xl border dark:border-gray-700 shadow-sm transition-colors h-full flex flex-col">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-bold flex items-center gap-2 dark:text-white">
                    <ClipboardList className="w-5 h-5 text-gray-700 dark:text-gray-300" /> 未完了タスク
                </h2>
              ...
              {pendingTasks && pendingTasks.length > 0 ? (
                <div className="flex flex-col gap-3 flex-1 overflow-y-auto max-h-[500px]">
                  {pendingTasks.map((task) => (
                    <Link href={`/companies/${task.company_id || '#'}`} key={task.id} className="block group">
                        <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded border border-transparent dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-500 hover:bg-white dark:hover:bg-gray-700 transition">
                            <div className="mt-1 w-4 h-4 rounded border-2 border-gray-400 dark:border-gray-400 group-hover:border-gray-600 dark:group-hover:border-gray-300 transition"></div>
                            <div className="flex-1 min-w-0">
                                <div className="font-medium text-sm dark:text-gray-100 group-hover:text-gray-900 dark:group-hover:text-white transition truncate">{task.title}</div>
                  ...
                  <div className="mt-auto pt-4 text-center">
                    <Link href="/companies" className="text-xs text-gray-500 hover:text-gray-900 dark:hover:text-gray-300 hover:underline">
                        すべてのタスクを見る &rarr;
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center py-8 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-dashed border-gray-200 dark:border-gray-700">
                    <div className="mb-3 p-3 bg-gray-100 dark:bg-gray-800 rounded-full">
                        <CheckCircle2 className="w-8 h-8 text-gray-400" />
                    </div>
                    <p className="text-gray-900 dark:text-white font-medium mb-2">タスク完了</p>
