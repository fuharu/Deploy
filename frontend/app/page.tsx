    ...
    <div className="container mx-auto p-4 md:p-8 max-w-7xl">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
        ...
        <div className="flex gap-4">
          ...
          <Link
            href="/companies"
            className="bg-indigo-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-indigo-700 transition shadow-md text-sm flex items-center gap-2"
          >
             企業一覧へ
          </Link>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
           ...
           <section>
              ...
              <div className="grid grid-cols-2 gap-4">
                  <Link href="/companies/new" className="group p-4 bg-gradient-to-br from-indigo-500 to-violet-600 text-white rounded-xl shadow hover:shadow-lg hover:scale-[1.02] transition flex flex-col items-center justify-center gap-2 h-24">
                      <Building2 className="w-8 h-8 group-hover:rotate-12 transition transform" />
            ...
            <section className="bg-white dark:bg-gray-800 p-5 rounded-xl border dark:border-gray-700 shadow-sm transition-colors h-full flex flex-col">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-bold flex items-center gap-2 dark:text-white">
                    <ClipboardList className="w-5 h-5 text-green-500" /> 未完了タスク
                </h2>
              ...
              {pendingTasks && pendingTasks.length > 0 ? (
                <div className="flex flex-col gap-3 flex-1 overflow-y-auto max-h-[500px]">
                  {pendingTasks.map((task) => (
                    <Link href={`/companies/${task.company_id || '#'}`} key={task.id} className="block group">
                        <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded border border-transparent dark:border-gray-700 hover:border-indigo-200 dark:hover:border-indigo-500/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                  ...
                  <div className="mt-auto pt-4 text-center">
                    <Link href="/companies" className="text-xs text-indigo-500 hover:underline">
                        すべてのタスクを見る &rarr;
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center py-8 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-dashed border-gray-200 dark:border-gray-700">
                    <div className="mb-3 p-3 bg-green-50 dark:bg-green-900/30 rounded-full">
